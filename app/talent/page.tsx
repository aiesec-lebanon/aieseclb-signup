...
export default function TalentSignup() {
  ...
  style={{ ["--signup-bg" as any]: "url('/images/talent-form.jpg')" }}
>

      <div
        className="navbar-wrapper talent-nav"
        style={{ backgroundColor: "#0cb9c0" }}
      >
        <header className="navbar">
          <img
            src="/images/aiesec global talent.png"
            alt="AIESEC logo"
            className="logo"
          />
          <nav className="nav-right">
            ...
            <a className="nav-btn" href="/talent">
              Sign up
            </a>
          </nav>
        </header>
      ...
      <main className="signup-main">
        <div className="signup-card">
          <section className="signup-left">
            <div className="signup-topbar talent-color" />
            <div className="signup-inner">
              <div className="signup-header-row">
                <h2 className="signup-title">
  <span className="keyword talent">Intern</span>{" "}
  ...
  <div className="phone-row">
    ...
    />
                ...
                {/* ✅ Make required if you want to block submit unless checked */}
                ...
                <button type="submit" className="signup-submit talent-color">
                  SIGN UP
                </button>
